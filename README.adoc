...
Actually, current version of Besom (0.1.0) does not support Gradle build,
so `Pulumi.yaml` has to reference the application JAR build by Gradle in a manual invocation;
hopefully, Besom 0.2.0 will restore Gradle support...
